<?php
/** MILLDONE
 * Template: CRM Leads Unit Actions
 * src: crm_functions\templates\crm_lead_unit_actions.php
 * Displays action buttons for individual lead units in the WpEstate CRM system.
...
$edit_link = esc_url_raw(
    add_query_arg('lead_edit', absint($post_id), $edit_link)
);

// Generate delete URL
$delete_link = esc_url_raw(
    add_query_arg('delete_lead_id', absint($post_id), $list_link)
);
...
<div class="dropdown">
    <button class="btn btn-primary dropdown-toggle property_dashboard_actions_button" 
            type="button" 
