<?php
/** MILLDONE
 * WpResidence Theme - Developer Profile Template
 * src: page-templates\user_profile_developer.php
 * This template handles the display and functionality of the developer profile page
 * in the WpResidence theme, including contact information, social media links,
 * location details, and profile picture management.
 *
 * @package WpResidence
 * @subpackage DeveloperProfile
 * @since 1.0.0
 */

// Retrieve current user and developer information
...
// Define form fields for developer information
$developer_contact_information_fields = array(
    'developer_title' => array('label' => esc_html__('Developer Name', 'wpresidence'), 'meta' => 'first_name', 'type' => 'wpestate_title'),
    'userphone'       => array('label' => esc_html__('Phone', 'wpresidence'), 'meta_name' => 'developer_phone', 'type' => 'post_meta'),
    'useremail'       => array('label' => esc_html__('Email', 'wpresidence'), 'bypass' => $userID, 'meta' => 'user_email', 'type' => 'user_meta'),
    'usermobile'      => array('label' => esc_html__('Mobile', 'wpresidence'), 'meta_name' => 'developer_mobile', 'type' => 'post_meta'),
    'userskype'       => array('label' => esc_html__('Skype', 'wpresidence'), 'meta_name' => 'developer_skype', 'type' => 'post_meta'),
    'developer_address' => array('label' => esc_html__('Address', 'wpresidence'), 'meta_name' => 'developer_address', 'type' => 'post_meta'),
    'developer_taxes' => array('label' => esc_html__('Taxes', 'wpresidence'), 'meta_name' => 'developer_taxes', 'type' => 'post_meta'),
    'developer_license' => array('label' => esc_html__('License', 'wpresidence'), 'meta_name' => 'developer_license', 'type' => 'post_meta'),
);
...
$developer_social_information_fields = array(
    'userfacebook'  => array('label' => esc_html__('Facebook Url', 'wpresidence'), 'meta_name' => 'developer_facebook', 'type' => 'post_meta'),
    'userinstagram' => array('label' => esc_html__('Instagram Url', 'wpresidence'), 'meta_name' => 'developer_instagram', 'type' => 'post_meta'),
    'usertwitter'   => array('label' => esc_html__('X - Twitter Url', 'wpresidence'), 'meta_name' => 'developer_twitter', 'type' => 'post_meta'),
    'userpinterest' => array('label' => esc_html__('Pinterest Url', 'wpresidence'), 'meta_name' => 'developer_pinterest', 'type' => 'post_meta'),
    'userlinkedin'  => array('label' => esc_html__('Linkedin Url', 'wpresidence'), 'meta_name' => 'developer_linkedin', 'type' => 'post_meta'),
    'useryoutube'   => array('label' => esc_html__('Youtube Url', 'wpresidence'), 'meta_name' => 'developer_youtube', 'type' => 'post_meta'),
    'usertiktok'    => array('label' => esc_html__('TikTok Url', 'wpresidence'), 'meta_name' => 'developer_tiktok', 'type' => 'post_meta'),
    'usertelegram'  => array('label' => esc_html__('Telegram Url', 'wpresidence'), 'meta_name' => 'developer_telegram', 'type' => 'post_meta'),
    'uservimeo'     => array('label' => esc_html__('Vimeo Url', 'wpresidence'), 'meta_name' => 'developer_vimeo', 'type' => 'post_meta'),
    'developer_website' => array('label' => esc_html__('Website Url (without http)', 'wpresidence'), 'meta_name' => 'developer_website', 'type' => 'post_meta'),
);

// Define form fields for developer location
$developer_location_fields = array(
    'developer_city'    => array('label' => esc_html__('City', 'wpresidence'), 'meta' => 'last_name', 'type' => 'taxonomy_name', 'tax_name' => 'property_city_developer'),
    'developer_county'  => array('label' => esc_html__('State/County', 'wpresidence'), 'meta' => 'last_name', 'type' => 'taxonomy_name', 'tax_name' => 'property_county_state_developer'),
    'developer_area'    => array('label' => esc_html__('Area', 'wpresidence'), 'meta' => 'last_name', 'type' => 'taxonomy_name', 'tax_name' => 'property_area_developer'),
    'developer_address' => array('label' => esc_html__('Address', 'wpresidence'), 'meta_name' => 'developer_address', 'type' => 'post_meta'),
);

// Define form fields for developer category
$developer_category_fields = array(
    'agency_category_submit' => array('label' => esc_html__('Category', 'wpresidence'), 'inputype' => 'wp_dropdown', 'type' => 'taxonomy', 'meta_name' => 'developer_category', 'tax_name' => 'property_category_developer'),
    'agency_action_submit'   => array('label' => esc_html__('Action Category', 'wpresidence'), 'inputype' => 'wp_dropdown', 'meta_name' => 'developer_action', 'type' => 'taxonomy', 'tax_name' => 'property_action_developer'),
);

// Define form fields for developer details
$developer_about_details_fields = array(
    ...
    'developer_private_notes' => array('label' => esc_html__('Private Notes', 'wpresidence'), 'inputype' => 'textarea', 'meta_name' => 'developer_private_notes', 'type' => 'post_meta'),
);

// Get developer profile picture
...
<div class=" col-12 col-md-12 col-lg-8  user_profile_div">
    <div class="wpestate_dashboard_content_wrapper">
        ...
        <div class="add-estate profile-page profile-onprofile row">
            ...
            <?php echo wpestate_dashnoard_display_form_fields($developer_contact_information_fields, $developer_id); ?>
        ...
        <div class="add-estate profile-page profile-onprofile row">
            ...
            <?php echo wpestate_dashnoard_display_form_fields($developer_social_information_fields, $developer_id); ?>
        </div>

        <div class="add-estate profile-page profile-onprofile row">
            <div class="wpestate_dashboard_section_title"><?php esc_html_e('Category', 'wpresidence'); ?></div>
            <?php echo wpestate_dashnoard_display_form_fields($developer_category_fields, $developer_id); ?>
        </div>
        ...
        <div class="add-estate profile-page profile-onprofile row agency_map_wrapper">
            ...
            <?php echo wpestate_dashnoard_display_form_fields($developer_location_fields, $developer_id); ?>
            ...
            <input type="hidden" name="developer_lat" id="developer_lat" value="<?php echo esc_attr($developer_lat); ?>">
            <input type="hidden" name="developer_long" id="developer_long" value="<?php echo esc_attr($developer_long); ?>">
        </div>

        <div class="add-estate profile-page profile-onprofile row">
            <div class="wpestate_dashboard_section_title"><?php esc_html_e('About Agency', 'wpresidence'); ?></div>
            <?php echo wpestate_dashnoard_display_form_fields($developer_about_details_fields, $developer_id); ?>
        </div>
...
<?php if (wp_is_mobile()){ ?>
    <div class="fullp-button m-0 p-3">
            <button class="wpresidence_button w-100" id="update_profile_developer"><?php esc_html_e('Update profile', 'wpresidence'); ?></button>
            <?php
            $ajax_nonce = wp_create_nonce("wpestate_update_profile_nonce");
            echo '<input type="hidden" id="wpestate_update_profile_nonce" value="' . esc_attr($ajax_nonce) . '" />';
