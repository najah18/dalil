...
/**
 * MILLDONE
 * Blog Unit 2 Template
 * src templates\blog_card_templates\blog_unit2.php
 * This template is responsible for displaying individual blog post entries
 * in a specific layout (Blog Unit 2) throughout the WPResidence theme.
    ...
    <div class="blog_unit  property_listing_blog" data-link="<?php echo esc_attr($link); ?>">
        ...
        <div class="listing_details the_grid_view">
            ...
            if (has_post_thumbnail()) {
                echo wpestate_strip_excerpt_by_char(get_the_excerpt(), 115, $postID, '...');
            } else {
