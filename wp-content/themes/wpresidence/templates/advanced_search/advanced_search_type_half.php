...
<!--    <form role="search" method="get"   action="<?php print esc_url($adv_submit); ?>" >-->
            ...
            if( wpresidence_get_option('wp_estate_use_geo_location','')=='yes'){
                ...
                ?>
                    <div class="col-md-12 radius_wrap">
                        <input type="text" id="geolocation_search" class="form-control geolocation_search_item" name="geolocation_search" placeholder="<?php esc_html_e('Location','wpresidence');?>" value="">
                    ...
                    <div class="col-md-9 slider_radius_wrap">
                        ...
                        <input type="hidden" id="geolocation_radius" class="geolocation_radius" name="geolocation_radius" value="<?php print intval($radius_value);?>">
                    </div>
                <?php
        ...
        if ( $custom_advanced_search == 'yes'){
            ...
            if ( $adv_search_type==10 ){
                 ...
                 print  wpestate_show_search_field_10($action_select_list,esc_html__('Types','wpresidence'));
            }
            ...
            if ( $adv_search_type==11 ){
             ...
             if ( $adv_search_type==6 ){
                ...
                foreach($adv_search_what as $key=>$search_field){
                   ...
                   wpestate_show_search_field($adv_search_label[$key],'half',$search_field,$action_select_list,$categ_select_list,$select_city_list,$select_area_list,$key,$select_county_state_list,'','','','',$price_array_data);
                }
            }
        }else{
        ?>
