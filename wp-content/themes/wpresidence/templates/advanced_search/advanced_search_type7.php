...
function wpestate_show_adv6_form($adv_search_what,$adv_search_fields_no_per_row,$action_select_list,$categ_select_list,$select_city_list,$select_area_list,$select_county_state_list,$use_name,$term_id){
   ...
   $adv_search_label       =   wpresidence_get_option('wp_estate_adv_search_label','');
    ...
    foreach($adv_search_what as $key=>$search_field){
      ...
      'a1'.  wpestate_show_search_field_with_tabs($adv_search_label[$key],'mainform',$search_field,$action_select_list,$categ_select_list,$select_city_list,$select_area_list,$key,$select_county_state_list,$use_name,$term_id);
        print '</div>';
        }
