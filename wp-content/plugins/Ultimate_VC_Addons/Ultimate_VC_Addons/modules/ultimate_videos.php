		...
		public function get_video_thumb( $setting ) {
			...
			if ( 'custom' == $setting['thumbnail'] ) {
				...
				if ( 'uv_iframe' == $setting['video_type'] ) {
					...
					$vimeo = maybe_unserialize( file_get_contents( "https://vimeo.com/api/v2/video/$id.php" ) ); // phpcs:ignore WordPressVIPMinimum.Performance.FetchingRemoteData.FileGetContentsRemoteFile
