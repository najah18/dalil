...
class Featured_widget extends WP_Widget {
	...
	//function Featured_widget(){
		$widget_ops = array('classname' => 'featured_sidebar featured_sidebar_property', 'description' => 'Put a featured listing on sidebar.');
	...
	function widget($args, $instance){
		...
		print $before_widget;
                ...
                while ( $the_query->have_posts() ) :
                        ...
                        if($preview[0]==''){
                            $preview[0]= get_theme_file_uri('/img/defaults/default_property_featured_sidebar.jpg');
                        }
