...
(function () {
    "use strict";
    tinymce.create('tinymce.plugins.slider_properties', {
        init: function (ed, url) {
            ed.addButton('slider_properties', {
                title: 'slider_properties',
                image: url + '/tiny_icons/recent_posts.png',
                onclick: function () {
                    ed.selection.setContent('[slider_properties propertyid=""][/slider_properties]');
                }
            });
        },
    ...
    tinymce.PluginManager.add('slider_properties', tinymce.plugins.slider_properties);
})();
...
function fontawesomeMenu(){
    ...
    <ul class="font-awesome-icons">'+allfonticons()+'</ul></div>');
        ...
        jQuery(".font-awesome-icons li").on('click', function(){ 
