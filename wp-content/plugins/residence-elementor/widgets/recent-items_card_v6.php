...
class Wpresidence_Recent_Items_Card_V6 extends Widget_Base
{
    ...
    {
        return 'WpResidence_Items_List_card_v6';
    }
    ...
    {
        return __('Property List- Card V6', 'residence-elementor');
    }
        ...
        $this->end_controls_section();
              ...
              */
              ...
              $this->add_control(
                'details_back_color',
                [
                    'label'     => esc_html__( 'Property details background color', 'residence-elementor' ),
                    'type'      => Controls_Manager::COLOR,
                    'default'   => '',
                    'selectors' => [
                        '{{WRAPPER}} .property_unit_type5_content_details_second_row' => 'background-color: {{VALUE}}',
