...
class Wpresidence_Property_Page_Map_Section extends Widget_Base {
    ...
    public function get_title() {
        return __('Map Section', 'residence-elementor');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'no_colums', [
                ...
                'selectors' => [
                    '{{WRAPPER}} .google_map_shortcode_wrapper' => 'height: {{SIZE}}{{UNIT}}; z-index: 99;',
                    '{{WRAPPER}} .googleMap_shortcode_class' => 'height: {{SIZE}}{{UNIT}};',
        ...
        $this->add_group_control(
            Group_Control_Box_Shadow::get_type(), [
                'name' => 'box_shadow',
                'label' => esc_html__('Box Shadow', 'residence-elementor'),
                'selector' => '{{WRAPPER}} #accordion_prop_map',
            ]
        );
        ...
        $this->add_responsive_control(
            'border_radius', [
                ...
                'size_units' => ['px', '%'],
                'selectors' => [
                    '{{WRAPPER}} #accordion_prop_map' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    '{{WRAPPER}} .googleMap_shortcode_class' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'unit_color', [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} #accordion_prop_map' => 'background-color: {{VALUE}}',
