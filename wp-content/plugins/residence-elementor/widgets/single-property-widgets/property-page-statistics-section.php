...
class Wpresidence_Property_Page_Statistics_Section extends Widget_Base {
    ...
    public function get_name() {
        return 'property_show_statistics_section';
    }
    ...
    public function get_title() {
        return __('Statistics Section', 'residence-elementor');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_group_control(
            ...
            'name' => 'box_shadow',
            'label' => esc_html__('Box Shadow', 'residence-elementor'),
            'selector' => '{{WRAPPER}} #accordion_prop_stat',
                ]
        );
        ...
        $this->add_responsive_control(
            ...
            'selectors' => [
                '{{WRAPPER}} #accordion_prop_stat' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
        ...
        $this->add_responsive_control(
            'border_radius', [
                ...
                'size_units' => ['px', '%'],
                'selectors' => [
                '{{WRAPPER}} #accordion_prop_stat' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            'default' => '',
            'selectors' => [
                '{{WRAPPER}} #accordion_prop_stat' => 'background-color: {{VALUE}}',
    ...
    protected function render() {
        ...
        echo property_page_statistics_section_function($attributes, $settings);
    }
