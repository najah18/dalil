...
class Wpresidence_Property_Page_Walkscore_Section extends Widget_Base {
    ...
    public function get_name() {
        return 'property_show_walkcore_section';
    }
    ...
    public function get_title() {
        return __('Walkscore Section', 'residence-elementor');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_group_control(
            Group_Control_Box_Shadow::get_type(), [
                'name' => 'box_shadow',
                'label' => esc_html__('Box Shadow', 'residence-elementor'),
                'selector' => '{{WRAPPER}} #accordion_walkscore',
            ]
        );
        ...
        $this->add_responsive_control(
            'property_content_padding', [
                ...
                'selectors' => [
                    '{{WRAPPER}} #accordion_walkscore' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
        ...
        $this->add_responsive_control(
            'border_radius', [
                ...
                'size_units' => ['px', '%'],
                'selectors' => [
                    '{{WRAPPER}} #accordion_walkscore' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            'default' => \Elementor\Core\Kits\Documents\Tabs\Global_Typography::TYPOGRAPHY_PRIMARY
                ...
                'selector' => '{{WRAPPER}} .panel-body .walk_details',
            ]
        );
        ...
        $this->add_control(
            'unit_color', [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} #accordion_walkscore' => 'background-color: {{VALUE}}',
    ...
    protected function render() {
        ...
        echo property_page_walkscore_section_function($attributes, $settings);
    }
