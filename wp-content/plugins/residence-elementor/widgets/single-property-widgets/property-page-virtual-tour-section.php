...
class Wpresidence_Property_Page_Virtual_Tour_Section extends Widget_Base {
    ...
    public function get_name() {
        return 'property_show_virtual_tour_section';
    }
    ...
    public function get_title() {
        return __('Virtual Tour Section', 'residence-elementor');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_group_control(
            Group_Control_Box_Shadow::get_type(), [
                'name' => 'box_shadow',
                'label' => esc_html__('Box Shadow', 'residence-elementor'),
                'selector' => '{{WRAPPER}} #accordion_virtual_tour',
            ]
        );
        ...
        $this->add_responsive_control(
            'property_content_padding', [
                ...
                'selectors' => [
                    '{{WRAPPER}} #accordion_virtual_tour' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
        ...
        $this->add_responsive_control(
            'border_radius', [
                ...
                'size_units' => ['px', '%'],
                'selectors' => [
                    '{{WRAPPER}} #accordion_virtual_tour' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'unit_color', [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} #accordion_virtual_tour' => 'background-color: {{VALUE}}',
    ...
    protected function render() {
        ...
        echo property_page_virtual_tour_section_function($attributes, $settings);
    }
