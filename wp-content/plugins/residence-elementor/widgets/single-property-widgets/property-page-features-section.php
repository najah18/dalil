...
class Wpresidence_Property_Page_Features_Section extends Widget_Base {
    ...
    public function get_name() {
        return 'property_show_features_section';
    }
    ...
    public function get_title() {
        return __(' Features Section', 'residence-elementor');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_group_control(
            ...
            'name' => 'box_shadow',
            'label' => esc_html__('Box Shadow', 'residence-elementor'),
            'selector' => '{{WRAPPER}} #accordion_prop_features',
                ]
        );
        ...
        $this->add_responsive_control(
            'property_content_padding', [
                ...
                'selectors' => [
                    '{{WRAPPER}} #accordion_prop_features' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
        ...
        $this->add_responsive_control(
            'border_radius', [
                ...
                'size_units' => ['px', '%'], 
                'selectors' => [
                    '{{WRAPPER}} #accordion_prop_features' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',],
            ]
        );
        ...
        $this->add_control(
            ...
            'default' => '',
            'selectors' => [
                '{{WRAPPER}} #accordion_prop_features' => 'background-color: {{VALUE}}',
    ...
    protected function render() {
        ...
        echo property_page_features_section_function($attributes, $settings);
    }
