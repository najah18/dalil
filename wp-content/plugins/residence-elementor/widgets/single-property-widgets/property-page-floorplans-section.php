...
class Wpresidence_Property_Page_FloorPlan_Section extends Widget_Base {
    ...
    public function get_name() {
        return 'property_show_floorplans_section';
    }
    ...
    public function get_title() {
        return __('Floor Plans Section', 'residence-elementor');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_group_control(
            ...
            'name' => 'box_shadow',
            'label' => esc_html__('Box Shadow', 'residence-elementor'),
            'selector' => '{{WRAPPER}} #accordion_prop_floor_plans',
                ]
        );
        ...
        $this->add_responsive_control(
            ...
            'selectors' => [
                '{{WRAPPER}} #accordion_prop_floor_plans' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
        ...
        $this->add_responsive_control(
            'border_radius', [
                ...
                'size_units' => ['px', '%'],
                'selectors' => [
                    '{{WRAPPER}} #accordion_prop_floor_plans' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    '{{WRAPPER}} .front_plan_row' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    '{{WRAPPER}} .front_plan_row_image .floor_image img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
           ...
           'global' => [
            ...
            'selector' => '{{WRAPPER}} .panel-body,{{WRAPPER}} .panel-body .floor_title,{{WRAPPER}} .panel-body .floor_details  ',
                ]
        );
        ...
        $this->add_control(
            'unit_color', [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} #accordion_prop_floor_plans' => 'background-color: {{VALUE}}',
        ...
        $this->add_control(
            'property_floor_plan_back', [
                'label' => esc_html__('Floor plan Title Background Color', 'residence-elementor'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .front_plan_row' => 'background-color: {{VALUE}}',
                ],
            ]
        );

        $this->add_control(
            'property_floor_plan_font_color', [
                'label' => esc_html__('Floor Plan Font Color', 'residence-elementor'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .front_plan_row .floor_title' => 'color: {{VALUE}}',
                    '{{WRAPPER}} .front_plan_row .floor_details' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            'unit_font_color', [
                'label' => esc_html__('Floor Plan Description Color', 'residence-elementor'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
    ...
    protected function render() {
        ...
        echo property_page_floorplan_section_function($attributes, $settings);
    }
