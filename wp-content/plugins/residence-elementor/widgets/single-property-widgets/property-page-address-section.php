...
class Wpresidence_Property_Page_Address_Section extends Widget_Base {
    ...
    public function get_name() {
        return 'property_show_address_section';
    }
    ...
    public function get_title() {
        return __('Property Page Address Section', 'residence-elementor');
    }
    ...
    protected function register_controls() {
        ...
        // Control to hide the Google Maps section
        $this->add_control(
            'hide_google_maps', [
                'label' => esc_html__('Hide Open In Google Maps Button', 'residence-elementor'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Yes', 'residence-elementor'),
                'label_off' => esc_html__('No', 'residence-elementor'),
                'return_value' => 'none',
                'default' => '', // Default is 'No', which means it will be visible
                'selectors' => [
                    '{{WRAPPER}} .acc_google_maps' => 'display: {{VALUE}};', // Hide or show the Google Maps
                ],
            ]
        );
        ...
        $this->add_group_control(
            Group_Control_Box_Shadow::get_type(), [
                'name' => 'box_shadow',
                'label' => esc_html__('Box Shadow', 'residence-elementor'),
                'selector' => '{{WRAPPER}} #accordion_prop_addr',
            ]
        );
        ...
        $this->add_responsive_control(
            'property_content_padding', [
                ...
                'selectors' => [
                    '{{WRAPPER}} #accordion_prop_addr' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
        ...
        $this->add_responsive_control(
            'border_radius', [
                ...
                'size_units' => ['px', '%'],
                'selectors' => [
                    '{{WRAPPER}} #accordion_prop_addr' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
        ]
    );
        ...
        $this->add_group_control(
            ...
            'default' => \Elementor\Core\Kits\Documents\Tabs\Global_Typography::TYPOGRAPHY_PRIMARY
                ...
                'selectors' => [
                    '{{WRAPPER}} .panel-body',
                    '{{WRAPPER}} .panel-body .listing_detail',
                    '{{WRAPPER}} .panel-body .listing_detail a',
                    '{{WRAPPER}} .single-estate_property .listing_detail strong',
                ],
            ]
        );

        
        // Typography control for Google Maps section
        $this->add_group_control(
            Group_Control_Typography::get_type(), [
                'name' => 'google_maps_typography',
                'label' => esc_html__('Google Maps Typography', 'residence-elementor'),
               'global' => [
            'default' => \Elementor\Core\Kits\Documents\Tabs\Global_Typography::TYPOGRAPHY_PRIMARY
        ],
                'selector' => '{{WRAPPER}} .acc_google_maps',
                'condition' => [
                    'hide_google_maps!' => 'none', // Show this control only if Google Maps is visible
                ],
            ]
        );
        ...
        $this->add_control(
            'unit_color', [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} #accordion_prop_addr' => 'background-color: {{VALUE}}',
        ...
        // Background color control for Google Maps section
        $this->add_control(
            'google_maps_background_color', [
                'label' => esc_html__('Google Maps Background Color', 'residence-elementor'),
                'type' => Controls_Manager::COLOR,
                'default' => '#69c17d', // Default color
                'selectors' => [
                    '{{WRAPPER}} .acc_google_maps' => 'background-color: {{VALUE}};',
                ],
                'condition' => [
                    'hide_google_maps!' => 'none', // Show this control only if Google Maps is visible
                ],
    ...
    protected function render() {
        ...
        echo property_page_address_section_function($attributes, $settings);
    }
