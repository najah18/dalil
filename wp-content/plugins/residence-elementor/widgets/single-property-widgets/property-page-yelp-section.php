...
class Wpresidence_Property_Page_Yelp_Section extends Widget_Base {
    ...
    public function get_name() {
        return 'property_show_yelp_section';
    }
    ...
    public function get_title() {
        return __('Yelp Section', 'residence-elementor');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_group_control(
            ...
            'name' => 'box_shadow',
            'label' => esc_html__('Box Shadow', 'residence-elementor'),
            'selector' => '{{WRAPPER}} #accordion_yelp',
                ]
        );
        ...
        $this->add_responsive_control(
            ...
            'selectors' => [
                '{{WRAPPER}} #accordion_yelp' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
        ...
        $this->add_responsive_control(
            ...
            'size_units' => ['px', '%'],
            'selectors' => [
                '{{WRAPPER}} #accordion_yelp' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ],
                ]
        );
        ...
        $this->add_group_control(
           ...
           'global' => [
            ...
            'selector' => '{{WRAPPER}} .yelp_unit_name,{{WRAPPER}} .yelp_unit_distance, {{WRAPPER}} h4.yelp_category',
                ]
        );
        ...
        $this->add_control(
            ...
            'default' => '',
            'selectors' => [
                '{{WRAPPER}} #accordion_yelp' => 'background-color: {{VALUE}}',
        ...
        $this->add_control(
            ...
            'selectors' => [
                ...
                '{{WRAPPER}} .yelp_unit_name' => 'color: {{VALUE}}',
                '{{WRAPPER}} .yelp_unit_distance' => 'color: {{VALUE}}',
                '{{WRAPPER}} h4.yelp_category' => 'color: {{VALUE}}',
            ],
                ]
        );
        $this->end_controls_section();
    ...
    protected function render() {
        ...
        echo property_page_yelp_section_function($attributes, $settings);
    }
