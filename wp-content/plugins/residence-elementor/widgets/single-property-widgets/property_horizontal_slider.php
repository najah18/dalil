...
class Wpresidence_Property_Page_Horizontal_Slider extends Widget_Base {
    ...
    public function get_name() {
        return 'property_show_horizontal_slider';
    }
    ...
    public function get_title() {
        return __('Horizontal Slider', 'residence-elementor');
    }
...
//                '{{WRAPPER}} .carousel-indicators img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
...
//        );
        ...
        $this->add_control(
            'back_color', [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .wpestate_property_carousel.carouselhorizontal .caption-wrapper span' => 'background: {{VALUE}};',
                ],
            ]
        );
    ...
    protected function render() {
        ...
        print wpestate_horizontal_slider($property_id, 'listing_full_slider_1');
    }
