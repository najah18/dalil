...
class Wpresidence_Property_Page_Description_Section extends Widget_Base {
    ...
    public function get_name() {
        return 'property_show_description_section';
    }
    ...
    public function get_title() {
        return __('Description Section', 'residence-elementor');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_group_control(
            ...
            'name' => 'box_shadow',
            'label' => esc_html__('Box Shadow', 'residence-elementor'),
            'selector' => '{{WRAPPER}} .wpestate_property_description',
                ]
        );
        ...
        $this->add_responsive_control(
            'property_content_padding', [
                ...
                'selectors' => [
                    '{{WRAPPER}} .wpestate_property_description' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'border_radius', [
                ...
                'size_units' => ['px', '%'],
                'selectors' => [
                    '{{WRAPPER}} .wpestate_property_description' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'unit_color', [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .wpestate_property_description' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            'unit_font_color', [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .wpestate_property_description' => 'color: {{VALUE}}',
                    '{{WRAPPER}} .wpestate_property_description a' => 'color: {{VALUE}}',
                    '{{WRAPPER}} .download_docs' => 'color: {{VALUE}}',
                    '{{WRAPPER}} .single-estate_property .listing_detail strong',
                    '{{WRAPPER}} path.st0' => 'fill: {{VALUE}}',
                ],
            ]
        );
    ...
    protected function render() {
        ...
        echo property_page_description_section_function($attributes, $settings);
    }
