...
class Wpresidence_Property_Page_Masonary_Gallery2 extends Widget_Base {
    ...
    public function get_name() {
        return 'property_show_masonary_gallery_2';
    }
    ...
    public function get_title() {
        return __('Masonry Gallery - V2', 'residence-elementor');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_responsive_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .col-md-8.image_gallery' => 'height: {{SIZE}}{{UNIT}};',
                '{{WRAPPER}} .col-md-4.wpresidence_gallery_first_col .image_gallery ' => 'height: calc( {{SIZE}}{{UNIT}}/2 ) ;',
            ],
                ]
        );
       ...
       // Control for hover color
        $this->add_control(
            'hover_color', [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .img_listings_overlay' => 'transition: none', // Initial styles
                    '{{WRAPPER}} .img_listings_overlay:hover' => 'background-color: {{VALUE}}; opacity: 1;', // Hover styles
                ],
            ]
        );
    ...
    protected function render() {
        ...
        print wpestate_header_masonry_gallery_type2($property_id);
    }
