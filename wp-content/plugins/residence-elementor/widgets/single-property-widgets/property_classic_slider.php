...
class Wpresidence_Property_Page_Classic_Slider extends Widget_Base {
    ...
    public function get_title() {
        return __('Classic Slider', 'residence-elementor');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_responsive_control(
            'image_border_radius', [
                ...
                'size_units' => ['px', '%'],
                'selectors' => [
                    '{{WRAPPER}} .wpestate_property_carousel.classic-carousel .carousel-indicators a img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
