...
class Wpresidence_Filter_List_Properties_v3 extends Widget_Base
{
    ...
    {
        return 'Wpresidence_Filter_List_Properties_v3';
    }
    ...
    {
        return __('Properties List with Filter V3', 'residence-elementor');
    }
