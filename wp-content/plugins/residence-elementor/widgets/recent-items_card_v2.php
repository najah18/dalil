...
class Wpresidence_Recent_Items_Card_V2 extends Widget_Base
{
    ...
    {
        return 'WpResidence_Items_List_card_v2';
    }
    ...
    {
        return __('Property List- Card V2', 'residence-elementor');
    }
...
*/
        ...
        */
        ...
        $this->add_control(
            'buttons_color_hover',
            [
                'label'     => esc_html__( 'Share & Compare Hover Background Color', 'residence-elementor' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
