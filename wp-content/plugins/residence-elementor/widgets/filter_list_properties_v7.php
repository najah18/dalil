...
class Wpresidence_Filter_List_Properties_v7 extends Widget_Base
{
    ...
    {
        return 'Wpresidence_Filter_List_Properties_v7';
    }
    ...
    {
        return __('Properties List with Filter V7', 'residence-elementor');
    }
