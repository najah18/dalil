...
class Wpresidence_Recent_Items_Card_V1 extends Widget_Base
{
    ...
    {
        return 'WpResidence_Items_List_card_v1';
    }
    ...
    {
        return __('Property List- Card V1', 'residence-elementor');
    }
        ...
        $this->start_controls_section(
               ...
               $this->add_control(
                   ...
                   [
                       ...
                       'default' => '',
                       'selectors' => [
                           '{{WRAPPER}} .listing_details.the_grid_view' => 'display: {{VALUE}}!important;',
                           '{{WRAPPER}} .listing_details.the_list_view' => 'display: {{VALUE}}!important;',
                       ],
                   ]
               );
    ...
    */
    $this->start_controls_section(
            ...
            'default' => Global_Typography::TYPOGRAPHY_PRIMARY
                    ...
                    'selector' => '{{WRAPPER}} .property_listing .property-unit-information-wrapper h4 a',
                ]
            );
