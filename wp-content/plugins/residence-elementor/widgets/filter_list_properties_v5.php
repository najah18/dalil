...
class Wpresidence_Filter_List_Properties_v5 extends Widget_Base
{
    ...
    {
        return 'Wpresidence_Filter_List_Properties_v5';
    }
    ...
    {
        return __('Properties List with Filter V5', 'residence-elementor');
    }
