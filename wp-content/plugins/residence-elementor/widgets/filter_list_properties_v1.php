...
class Wpresidence_Filter_List_Properties_v1 extends Widget_Base
{
    ...
    {
        return 'Wpresidence_Filter_List_Properties_v1';
    }
    ...
    {
        return __('Properties List with Filter V1', 'residence-elementor');
    }
