...
class Wpresidence_Filter_List_Properties_v8 extends Widget_Base
{
    ...
    {
        return 'Wpresidence_Filter_List_Properties_v8';
    }
    ...
    {
        return __('Properties List with Filter V8', 'residence-elementor');
    }
