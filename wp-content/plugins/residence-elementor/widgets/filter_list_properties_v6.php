...
class Wpresidence_Filter_List_Properties_v6 extends Widget_Base
{
    ...
    {
        return 'Wpresidence_Filter_List_Properties_v6';
    }
    ...
    {
        return __('Properties List with Filter V6', 'residence-elementor');
    }
